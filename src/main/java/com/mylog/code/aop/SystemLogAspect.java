...
import com.mylog.common.util.DateUtils;
import com.mylog.common.util.UuidUtils;
...
/*	@Pointcut("@annotation(com.myron.ims.annotation.SystemServiceLog)")
	 ...
	 * Controller层切点 注解拦截
	 */
	@Pointcut("@annotation(com.mylog.code.annotation.SystemControllerLog)")
	public void controllerAspect(){}
	
	/**
	 * 方法规则拦截
	 */
	@Pointcut("execution(* com.mylog.code.controller.*.*(..))")
